...
// Milawei Workbench header instead — claiming Microsoft copyright on code they did
...
const copyrightHeaderVariants = [
	...
	[
		'/*---------------------------------------------------------------------------------------------',
		' *  Copyright (c) Milawei Workbench contributors. All rights reserved.',
		' *  Licensed under the MIT License. See License.txt in the project root for license information.',
		' *--------------------------------------------------------------------------------------------*/',
	],
];
...
export function hygiene(some: NodeJS.ReadWriteStream | string[] | undefined, runEslint = true): NodeJS.ReadWriteStream {
	...
	const productJson = es.through(function (file: VinylFile) {
		...
		// Milawei Workbench: as a third-party fork we must ship our own gallery
