		...
		assert.deepStrictEqual(
			{
				...
				mcpToolBorrowingAKnownReadId: tool('copilot_readFile', 'mcp:github'),
			...
			},
			{
				...
				mcpTool: GovernanceRiskTier.RemoteInfra,
				mcpToolBorrowingAKnownReadId: GovernanceRiskTier.RemoteInfra,
